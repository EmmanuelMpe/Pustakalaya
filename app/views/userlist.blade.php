	  ...
	  <form class="form">
	    <fieldset>
	      <div class="form-group">
	        ...
	        <div class="col-lg-2">
	          <select id="inputType">
	          	<option>Staff</option><option>Student</option>
	          </select>
	        </div>
	      </div>
	      ...
	      <div class="form-group">
	        ...
	        <div class="col-lg-3">
	          <select id="inputAuthority">
	          	<option>Administrator</option><option>Librarian</option><option>Verifier</option>
	          </select>
	        </div>
	      </div>
	      <div class="form-group hidden">
	        ...
	        <div class="col-lg-2">
	          <select id="inputBatch">
	          	<option>2068</option><option>2069</option><option>2070</option><option>2071</option>
	          </select>
	        </div>
	      </div>
	      <div class="form-group hidden">
	        ...
	        <div class="col-lg-2">
	          <select id="inputProgram">
	          	<option>BAE</option><option>BCE</option><option>BCT</option>
	          	<option>BEL</option><option>BEX</option><option>BME</option>
	          </select>
	        </div>
	      </div>
	      <div class="form-group">
